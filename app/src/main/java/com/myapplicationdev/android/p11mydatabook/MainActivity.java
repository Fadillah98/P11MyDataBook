...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Drawable> drawers;
    ArrayAdapter<Drawable> aa;
    String currentTitle;
    ActionBar ab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawers.add(new Drawable("Bio"));
        drawers.add(new Drawable("Vaccination"));
        drawers.add(new Drawable("Anniversary"));
        drawers.add(new Drawable("About Us"));

        ab = getSupportActionBar();
        aa = new DrawableAdapter(getBaseContext(), R.layout.customdrawable, drawers);
        ...
        drawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                currentTitle = drawers.get(position).getItem();
